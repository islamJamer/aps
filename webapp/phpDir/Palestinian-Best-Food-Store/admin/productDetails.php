<?php
    ...
    // include $tpl . 'productDetails.php';
?>
                        ...
                        <div class="col-md-7">
                            <div class="product-content">
                                ...
                                <form class="action" method="post" >
                                    <a href="employeeHome.php"><button class="btn" name="deleteProduct">Delete Product</button></a>
                                </form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row product-detail-bottom">
                    <div class="col-lg-12">
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="pill" href="#reviews">Handle Product</a>
                            </li>
                        </ul>
